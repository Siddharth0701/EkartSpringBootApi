...
import com.ekart.dao.IProductRepository;
...
//	Entity=>DTO
	...
	@Override
	public ProductData findById(Long id) throws NoIdFoundException {

		Optional<Product> productOptional = productRepository.findById(id);
		if (productOptional == null) {
			new NoIdFoundException("Product Not Found");
		}
	...
	public boolean update(ProductData productData, Long productId) {
		...
		if (product2 != null) {
			...
			product2.setImageUrl(productData.getImageUrl());
